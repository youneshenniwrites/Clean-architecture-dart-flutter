...
void main() {
  ...
  test('initialState should be enpty', () {
    // assert
  ...
  group('GetTriviaForConcreteNumber', () {
    ...
    test(
      ...
      convert the string to an unsinged integer''',
      () async {
        // arrange
    ...
    test(
      ...
      () async {
        ...
        // ! assert later: Register expectations before the bloc executes any logic
        final expected = [
          Empty(),
